    ...
    dbConfig.executeQuery(sql).then(
      result => {
        ...
        osDescription.numero =
          osResult.numero !== "null" ? osResult.numero : "";
        osDescription.bairro =
          osResult.bairro !== "null" ? osResult.bairro : "";
        osDescription.cidade =
          osResult.cidade !== "null" ? osResult.cidade : "";
        osDescription.estado =
          osResult.estado !== "null" ? osResult.estado : "";
