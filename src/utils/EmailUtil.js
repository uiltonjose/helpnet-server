...
const sendMail = (subject, content, emailsTo) => {
...
const builderContentMailNewOS = osDescription => {
  if (osDescription.nomeCliente == "null" || osDescription.nomeCliente == null)
  ...
  if (osDescription.cli_ativado == "null" || osDescription.cli_ativado == null)
...
module.exports = {
  sendMail: sendMail,
  builderContentMailNewOS: builderContentMailNewOS
};
